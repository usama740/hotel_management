...
It includes views for user registration and user login, with custom logic for 
handling user creation and authentication.
...
class UserRegistrationView(APIView):
    ...
    def post(self, request):
        ...
        It takes the user data from the request, attempts to create the user 
        using the UserRepository, and returns a success response if creation is successful.
...
class UserLoginView(APIView):
    ...
    def post(self, request):
        ...
        It takes the username and password from the request, authenticates the user, 
        and returns access and refresh tokens if authentication is successful.
        ...
        res, status_code = user_repo.login_user(
            ...
            password=password,
            request=request,
            custom_refresh_token=CustomRefreshToken()  # Use custom refresh token logic
        )
