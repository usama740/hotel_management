...
or similar context. It includes fields for the name, description, price, and creation timestamp.
"""
...
class Menu(models.Model):
    ...
    Attributes:
        ...
        price (Decimal): The price of the menu item, stored with up to 8 digits and 2 decimal places.
