"""
This module defines the `Reservation` model, which represents a room reservation made by a user.
The model includes fields for the user, room number, check-in and check-out dates, and timestamps
...
class Reservation(models.Model):
    ...
    def __str__(self):
        """
        Returns a string representation of the reservation, including the reservation ID,
        the username of the user who made it, and the check-in and check-out dates.
