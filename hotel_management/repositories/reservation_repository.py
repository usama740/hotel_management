...
operations such as creating, retrieving, updating, and deleting reservations.
It interacts with the reservation model and performs validation and error handling using serializers.
"""
...
class ReservationRepository:
    ...
    This class handles creating, retrieving, updating, and deleting reservations for users.
