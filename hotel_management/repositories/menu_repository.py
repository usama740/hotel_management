...
operations such as creating, retrieving, updating, and deleting menu items.
It interacts with the menu model and performs validation using serializers.
"""
...
class MenuRepository:
    ...
    This class handles creating, retrieving, updating, and deleting menu items.
        ...
        if serializer.is_valid():
            ...
            for field, messages in serializer.errors.items():
                for message in messages:
                    # We directly append the custom error messages
    ...
    def update_menu_item(self, menu_item_id, data, menu_serializer):
        ...
        serializer = menu_serializer(menu_item, data=data, partial=True)  # Allow partial updates
        if serializer.is_valid():
            serializer.save()
