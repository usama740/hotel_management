...
such as creating users, fetching users by username, and logging in users.
It includes custom validation error handling and token generation for authentication.
"""
...
class UserRepository:
    ...
    This class handles user creation, retrieval, and login functionalities.
    ...
    def login_user(self, username, password, request, custom_refresh_token):
        ...
        and returns access and refresh tokens for authenticated users.
